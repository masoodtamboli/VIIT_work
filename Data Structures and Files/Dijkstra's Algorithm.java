// Java Program for any application to find Single source shortest path using Dijkstra’s algorithm
...
{
    private static void Dijkstras(int[][] adjancyMatrix) {
